//
//  ADCreateAccountViewController.m
...
@interface ADCreateAccountViewController ()

@end

@implementation ADCreateAccountViewController
...
- (IBAction)createAccountButtonPressed:(UIButton *)sender {
    ...
    if ((self.usernameTextField.text.length != 0) && (self.passwordTextField.text.length != 0) && [self.passwordTextField.text isEqualToString:self.confirmPasswordTextField.text])
    {
        ...
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Information not entered correctly" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alertView show];
    }
}
